...
Provide a geography taxonomy called GeoAreas containing the hierarchical areas inside the State of Israel.
...
1. Upload the plugin files to the `/wp-content/plugins/geoarea-israel` directory, or install the plugin through the WordPress plugins screen directly.
